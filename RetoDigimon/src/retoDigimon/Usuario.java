...
public class Usuario {
    ...
    Usuario(){
     ...
     public void creaUsuario() {
         ...
         for ( int i=0; i<nombreusu.length; i++) {
            nombreusu[i]= Methods.datoString("Inserta el nombre de usuario: ");
            contraseñausu[i]= Methods.datoString("Inserta la contraseña: ");
    ...
    public static void getcodynom(int code) { 
        codigousu=code;
